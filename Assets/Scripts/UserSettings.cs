...
public class UserSettings : MonoBehaviour
{
    ...
    public void LoadFromPlayerPrefs(int slot)
    {
        ...
        preferences.cursorRadiusMin = PlayerPrefs.GetFloat("cursorRadiusMin" + slot);
        preferences.cursorRadiusMax = PlayerPrefs.GetFloat("cursorRadiusMax" + slot);
        preferences.cursorDistance = PlayerPrefs.GetFloat("cursorDistance" + slot);
        preferences.cursorDistanceMin = PlayerPrefs.GetFloat("cursorDistanceMin" + slot);
        preferences.cursorDistanceMax = PlayerPrefs.GetFloat("cursorDistanceMax" + slot);
    ...
    public void SaveToPlayerPrefs(int slot)
    {
        ...
        PlayerPrefs.SetFloat("cursorRadiusMin" + slot, preferences.cursorRadiusMin);
        PlayerPrefs.SetFloat("cursorRadiusMax" + slot, preferences.cursorRadiusMax);
        PlayerPrefs.SetFloat("cursorDistance" + slot, preferences.cursorDistance);
        PlayerPrefs.SetFloat("cursorDistanceMin" + slot, preferences.cursorDistanceMin);
        PlayerPrefs.SetFloat("cursorDistanceMax" + slot, preferences.cursorDistanceMax);
